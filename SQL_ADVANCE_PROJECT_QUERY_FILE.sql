...
--- Task2 : For each brand, find the latest year’s top 2 cars by sale in each country,
---  but only if that country sold more than 100 cars total.
...
---Task3 : For each brand, find the average sale price per year and
--- show the difference compared to the previous year’s average
...
--- Task 5 : For each brand, calculate the total sales per country and then find the
--- percentage contribution of each country to that brand’s overall sales.
...
--- TASK 9: Find all brands where the total sales in 2024 are higher than 
--- the average total sales of that brand across all years.
...
"""Task10 : Find all customers (use first_name, last_name, address) who bought cars 
of more than 1 brand in the same year. Show first_name, last_name, address, year, and brand_count."""
...
""" Task 11: For each brand, calculate the cumulative sales over the years (running total).
	Show brand, year, total_sale_year, and cumulative_sale"""
...
""" Task 12 : Find all cars where the customer’s first name starts with ‘A’ or last name ends with
    ‘n’, and the car color contains ‘red’ (case-insensitive)"""
...
""" TASK 13: For each brand, calculate the percentage change in total sales 
compared to the previous year. Show brand, year, total_sale, prev_year_sale, and pct_change."""
...
"""TASK 14: For each brand, find the average sale price per year and 
show the difference compared to the previous year’s average"""
...
""" TASK 15: Q6. Customer Segmentation by Spend
...
"TASK 16 : Generate a sequence of years from 2001 to 2024 using a recursive CTE.
Show column: year"
